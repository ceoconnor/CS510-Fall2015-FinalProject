...
MATRIX new_matrix(const VALUE, const VALUE, const VALUE, const VALUE, const INDEX, const INDEX);
// Destructor for allocated memory
void delete_matrix(MATRIX);
// Setter for individual elements
void set(MATRIX *, const VALUE, const VALUE, const VALUE, const VALUE, const INDEX, const INDEX, const VALUE);
